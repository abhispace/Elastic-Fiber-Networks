...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 28 12:23:24 2025
this is a copy of dipole_moment_means.y so that I can run tests of srand 113, 114, ... 122
for N = 1,2,5,10

it also reads in the means files (written by dipole_moment_plots.py)
...
bending_flag = 1         # set this to 1 for looking at only bending dominated cases
...
for kappa in kappa_list:
    ...
    for num_center in num_center_list:
        ...
        if bending_flag == 0:
            fname = base+folder+"all_dom_mean_dip_mom_bndry_force_"+str(L)+"_"+str(num_center)+"_"+str(num_dip)+"_"+pbond_string+"_"+tol_str+"_"+kappa_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+"_"+str(num-1)+".txt"  
            plot_folder = plot_folder + str(L)+"_all_dom_"
            
        data = np.loadtxt(fname)        
        data_all[i].append(data)

        # reading the mean energy values
        mean_en_fname = base+folder+"all_dom_mean_en_"+str(L)+"_"+str(num_center)+"_"+str(num_dip)+"_"+pbond_string+"_"+tol_str+"_"+kappa_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+"_"+str(num-1)+".txt"
        en_data = np.loadtxt(mean_en_fname)        
        en_data_all[i].append(en_data)

    i += 1

data_all = np.array(data_all)
en_data_all = np.array(en_data_all)
...
yerr_sem = data_all[:,:,2]/np.sqrt(data_all[:,:,0])
yerr = data_all[:,:,2]
...
plt.errorbar(num_center_list, data_all[0,:,1], yerr = yerr_sem[0,:], c = 'b', fmt = 'o', label = '$\widetilde \kappa = 10^{-6}$')
# plt.errorbar(num_center_list, data_all[0,:,1], yerr = asymmetric_error, c = 'b', fmt = 'o', label = '$\widetilde \kappa = 10^{-6}$')
...
plt.legend(loc = 'best')
plt.savefig(base+plot_folder+"dip_mom_vs_N_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")

plt.clf()
plt.close()


# log_num_dip = np.log(num_center_list)
# log_dfar = np.log(data_all[0,:,1])
# log_yerr = yerr / (data_all[0,:,1] * np.log(10))  # error propagation in log10

# # plotting the dipole moments vs number of dipoles for all kappa
# plt.figure(figsize=(8, 5), dpi=300)
# # plt.errorbar(num_center_list, data_all[0,:,1], yerr = data_all[0,:,2], c = 'b', fmt = 'o', label = '$\widetilde \kappa = 10^{-6}$')
# plt.errorbar(log_num_dip, log_dfar, yerr = log_yerr, c = 'b', fmt = 'o', label = '$\widetilde \kappa = 10^{-6}$')
# # plt.errorbar(num_center_list, data_all[1,:,1], yerr = yerr[1,:], c = 'g', fmt = 'd', label = '$\widetilde \kappa = 10^{-5}$')
# # plt.errorbar(num_center_list, data_all[2,:,1], yerr = yerr[2,:], c = 'k', fmt = 's', label = '$\widetilde \kappa = 10^{-4}$')
...
# plt.subplots_adjust(right=0.96,left=0.18,top=0.94,bottom=0.12)
# plt.legend(loc = 'best')
# plt.savefig(base+plot_folder+"dip_mom_vs_N_logged_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
# plt.clf()
# plt.close()
...
plt.legend(loc = 'best')
plt.savefig(base+plot_folder+"dip_mom_vs_N_packing_frac_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
...
# plt.errorbar(num_center_list, data_all[2,:,5], yerr = yerr[2,:], c = 'k', fmt = 's', alpha = 0.5, label = '$\widetilde \kappa = 10^{-4}$')
# plt.errorbar(num_center_list, data_all[1,:,5], yerr = yerr[1,:], c = 'g', fmt = 'd', alpha = 0.5, label = '$\widetilde \kappa = 10^{-5}$')
plt.errorbar(num_center_list, data_all[0,:,5], yerr = yerr[0,:], c = 'b', fmt = 'o', alpha = 0.5, label = '$\widetilde \kappa = 10^{-6}$')
...
plt.plot(x_linspace, line_fit1, c = 'b', label = '$ {N}^{1} $') 
# plt.plot(x_linspace, line_fit2, c = 'g') 
# plt.plot(x_linspace_e5, line_fit2, c = 'g') 
# plt.plot(x_linspace, line_fit3, c = 'k') 
...
plt.legend(loc = 'best')
plt.savefig(base+plot_folder+"dip_loc_mom_vs_N_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
...
plt.legend(loc = 'best')
plt.savefig(base+plot_folder+"dip_mom_vs_N_linear_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
...
plt.subplots_adjust(right=0.96,left=0.18,top=0.94,bottom=0.12)
plt.legend(loc = 'best')
plt.savefig(base+plot_folder+"dip_mom_vs_N_semi_log_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
plt.clf()
plt.close()
...
plt.subplots_adjust(right=0.96,left=0.18,top=0.94,bottom=0.12)
plt.legend(loc = 'best')
plt.savefig(base+plot_folder+"dip_mom_vs_N_linear_kappa_1e-6_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
plt.clf()
plt.close()
...
plt.subplots_adjust(right=0.96,left=0.18,top=0.94,bottom=0.12)
plt.legend(loc = 'best')
plt.savefig(base+plot_folder+"dip_mom_vs_N_log_kappa_1e-6_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
plt.clf()
plt.close()
...
plt.subplots_adjust(right=0.96,left=0.18,top=0.94,bottom=0.12)
plt.legend(loc = 'best')
plt.savefig(base+plot_folder+"dip_mom_vs_N_semi_log_kappa_1e-6_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
plt.clf()
plt.close()
...
#============================================================================================
outfname = base + folder + "mean_dip_mom_vs_N_values_"+str(srand)+"_"+str(num_center)+"_"+str(num_dip)+"_"+pbond_string+"_"+tol_str+"_"+kappa_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+"_"+str(num-1)+".txt"
if bending_flag == 0:
...
heading = 'N         mean dfar         std dfar         sem dfar'
fmt = '%12d', '%15.7e', '%15.7e', '%15.7e'
np.savetxt(outfname, np.column_stack((num_center_list, data_all[0,:,1], np.squeeze(yerr), np.squeeze(yerr_sem))), header = heading, fmt = fmt)


#============================================================================================
# writing the mean energy values vs N to an output file
#============================================================================================
outfname = base + folder + "mean_energy_vs_N_values_"+str(srand)+"_"+str(num_center)+"_"+str(num_dip)+"_"+pbond_string+"_"+tol_str+"_"+kappa_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+"_"+str(num-1)+".txt"
if bending_flag == 0:
...
heading = '        N          #sim   mean el en      std el en     mean bend en     std bend en      mean en ratio     std en ratio'
fmt = '%12d', '%12d', '%15.7e', '%15.7e', '%15.7e', '%15.7e', '%15.7e', '%15.7e'
np.savetxt(outfname, np.column_stack((num_center_list, en_data_all[0,:,0], en_data_all[0,:,1], en_data_all[0,:,2], en_data_all[0,:,3], en_data_all[0,:,4], en_data_all[0,:,5], en_data_all[0,:,6])), header = heading, fmt = fmt)
...
plt.savefig(base+plot_folder+"dip_mom_vs_kappa_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
...
plt.errorbar(kappa_list, data_all[:,1,1], yerr = yerr[:,1], c = 'g', fmt = 'd', label = 'N = 2')
plt.errorbar(kappa_list, data_all[:,2,1], yerr = yerr[:,2], c = 'k', fmt = 's', label = 'N = 5')
plt.errorbar(kappa_list, data_all[:,3,1], yerr = yerr[:,3], c = 'k', fmt = 's', label = 'N = 10')
...
plt.legend(loc = 'best')
plt.savefig(base+plot_folder+"dip_mom_vs_kappa_log_fit_scaled_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
...
plt.legend(loc = 'best')
plt.savefig(base+plot_folder+"dip_mom_vs_kappa_log_fit_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
...
plt.legend(loc = 'best')
plt.savefig(base+plot_folder+"test_"+ str(srand) +"_" +pbond_string+"_"+tol_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+".png")
...
num_c = [1,2,5,10,15,20,25,30,35,40]
...
if bending_flag == 0:
    fname_plot = fname_plot + str(L)+'_all_dom_'
...
for i in range(0,len(num_c)):
    ...
    if srand_flag == 1 and L == 64:
        ...
        fname_p1 = fname_base + 'dipole_moment_ratio_'+ 'srand_'+ str(srand) +'_'+str(num_c[i])+'_'+str(num_c[i]*6)+'_'+pbond_string+ "_"+tol_str+"_"+ kappa_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+'_10.txt'
    # if srand_flag == 1 and bending_flag == 0:
    #     fname_p1 = fname_base + 'all_dom_dipole_moment_ratio_'+ 'srand_'+ str(srand) +'_'+ str(L) +'_'+str(num_c[i])+'_'+str(num_c[i]*6)+'_'+pbond_string+ "_"+tol_str+"_"+ kappa_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+'_10.txt'
...
# saving the data:
outfname = base + folder + "alpha_m_values_"+str(srand)+"_"+str(num_center)+"_"+str(num_dip)+"_"+pbond_string+"_"+tol_str+"_"+kappa_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+"_"+str(num-1)+".txt"
if bending_flag == 0:
    outfname = base + folder + "all_dom_alpha_m_values_"+str(L)+'_'+str(srand)+"_"+str(num_center)+"_"+str(num_dip)+"_"+pbond_string+"_"+tol_str+"_"+kappa_str+"_"+rlen_txt+"_"+mu_str+"_"+mu_c_str+"_"+str(num-1)+".txt"
print('here the alpha_m values are written to file : ',outfname)    
heading = 'N         alpha_m         alpha_m error'
fmt = '%12d', '%15.7e', '%15.7e'
np.savetxt(outfname, np.column_stack((num_center_list, alpha_m_kappae_6, yerr_alpha_m_kappae_6)), header = heading, fmt = fmt)

    
#################################################################################################################################
# for L = 128: manually writing the dfar values 
#################################################################################################################################
num_list_128 = [1, 8, 20, 40, 60, 80, 100, 120, 140, 160]
dfar116 = []