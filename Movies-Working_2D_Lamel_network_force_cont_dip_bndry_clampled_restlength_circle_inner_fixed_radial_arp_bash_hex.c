...
//	if ((L == 64) && (PBOND == 1.0)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/strain/Lattice_");
	}
	
	else if ((PBOND < 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/kappa2_");
...
//	if ((L == 64) && (PBOND == 1.0)){
	if ((PBOND == 1.0)){
//		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/force/1Force_");
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/force/Force_");
	}
...
//	if ((L == 64) && (PBOND == 1.0)){
	if ((PBOND == 1.0)){
//		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/force/1Force_");
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/force/xi_Force_");
	}
...
//	if ((L == 64) && (PBOND == 1.0)){
	if ((PBOND == 1.0)){
//		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/force/1Force_");
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/rlen/rlen_");
	}
...
//	if ((L == 64)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/dip_nodes/Dipole_nodes_");
	}
...
//	if ((L == 64)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/dip_nodes/Unique_dipole_nodes_");
	}
...
//	if ((L == 64)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/strain/Lattice_connect_");
	}
...
//	if ((L == 64)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/area/Boundary_nodes_");
	}
...
//	if ((L == 64)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/area/Inner_nodes_");
	}
...
//	if ((L == 64)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/area/Outer_nodes_");
	}
...
//	if ((L == 64) && (PBOND == 1.0)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/strain/Strain_Lattice_");
	}
...
//	if ((L == 64)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/movie/Lattice_");
	}
...
//	if ((L == 64)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/energy/strain/Lattice_");
	}
...
//	if ((L == 64)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/energy/node/Lattice_node_");
...
//	if ((L == 64) && (PBOND == 1.0)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/energy/movie/cg_accepted_movie");
	}
...
//	if ((L == 64) && (PBOND == 1.0)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/CG/Lattice_");
	}
...
//	if ((L == 64) && (PBOND == 1.0)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/energy/movie/movie");
	}
...
//	if ((L == 64) && (PBOND == 1.0)){
	if ((PBOND == 1.0)){
		strcpy(filename,"lattice_nopbd_bndry_all_clamp_restlength_circle_inner_fixed_radial_arp_bash_hex/txt/bend/strain/Lattice_bend_");
	}
